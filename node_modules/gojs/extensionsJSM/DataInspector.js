...
export class Inspector {
    ...
    buildPropertyRow(propertyName, propertyValue) {
        ...
        // Código  insertado para mostrar Tooltip en el DataInspector
        var definiciones = [
            {
                id: "id",
                definicion: propertyValue
            },
            {
                id: "points",
                definicion: propertyValue
            ...
            {
                id: "coupling_AIS",
                definicion: "Absolute Importance of the Service: number of consumers"
                + " invoking at least one operation from a service S1. The higher th"
                + "e AIS, the more important the service S1 is within the system. Av"
                + "erage AIS can be useful for identifying and quantifying the most "
                + "critical services."
            },
            {
                id: "coupling_ADS",
                definicion: "Absolute Dependence of the Service: number of services "
                + "on which the S1 service depends. In other words, ADS is the numbe"
                + "r of services that S1 calls for its operation to be complete. The"
                + " higher the ADS, the more this service depends on other services,"
                + " i.e., it is more vulnerable to the side effects of failures in t"
                + "he services invoked."
            },
            {
                id: "coupling_SIY",
                definicion: "Services Interdependence in the System are metrics of "
                + "cyclical dependency that are not used because the mere existence"
                + " of a single dependency of this type already constitutes an arch"
                + "itectural smell. Therefore, it makes no sense to analyze the var"
                + "iability or trend of a metric for which we know that the only ac"
                + "ceptable value would be zero."
            },
            {
                id: "cohesion_lack",
                definicion: "Definition for cohesion lack"
            },
            {
                id: "cohesion_grade",
                definicion: "Definition for cohesion grade"
            },
            {
                id: "complexity",
                definicion: "Definition for complexity"
            },
            {
                id: "semantic_similarity",
                definicion: "Definition for semantic similarity"
            }
        ];
